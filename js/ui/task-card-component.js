...
function isToday(someDate) {
    ...
    // CRÍTICO: Ajusta a data para o fuso horário do usuário antes de comparar.
...
function formatDate(isoDate) {
    ...
    // CRÍTICO: Ajusta a data para o fuso horário do usuário antes de formatar.
...
export function createTaskCard(task, projects, eventHandlers) {
    ...
    if (task.dueDate) {
        ...
        dueDateDiv.innerHTML = `<span>${formatDateShort(task.dueDate)}</span>`;
    ...
    const saveDate = () => {
        ...
        if (newDate) {
            ...
            dueDateDiv.innerHTML = `<span>${formatDateShort(newDate)}</span>`;
        } else {
            dueDateDiv.innerHTML = calendarIcon;
        }
